...
export default function AdminAuth() 
{
    ...
    <>
        ...
        <div className="container my-4" id="login-wrapper">
            ...
            <form onSubmit={Submit}>
                ...
                <Button type="submit" padding= "2rem" sx={{backgroundColor:"#1D1D20", color:"white", width:"30%" , marginTop:"1%"}}> Login </Button>
            </form>
        </div>
        <Typography className="text-center" color="#1D1D20" fontWeight="700px" fontSize="1rem" marginTop="1vw" marginBottom="2rem"> Don't have an account? <Link to="/Customer/Registeration">Register</Link> </Typography>
